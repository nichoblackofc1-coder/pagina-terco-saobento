...
const reviews = [
  {
    ...
    date: "ha 2 dias",
    verified: true,
    text: "Adeus foliculite! Sofria muito com pelos encravados na virilha e agora minha pele esta lisinha. O LissPro nao puxa e nao machuca. Melhor compra que fiz!",
    likes: 234,
    photos: [],
  },
  {
    ...
    date: "ha 5 dias",
    verified: true,
    text: "Eu tinha medo de depilador eletrico, mas esse e diferente! Nao corta, nao irrita e deixa a pele super macia. Uso nas pernas, axila e virilha. Recomendo demais!",
    likes: 189,
    photos: [],
  },
  {
    ...
    date: "ha 1 semana",
    verified: true,
    text: "Finalmente encontrei um depilador que funciona de verdade! A ponteira menor e perfeita pro buco e sobrancelha. Ja joguei minha gilete fora!",
    likes: 156,
    photos: [],
  },
  {
    ...
    date: "ha 2 semanas",
    verified: true,
    text: "Muito pratico e silencioso! A bateria dura bastante e carrega rapido no USB. Uso principalmente na virilha que era meu maior problema com foliculite.",
    likes: 98,
    photos: [],
  },
  {
    ...
    date: "ha 3 semanas",
    verified: true,
    text: "Minha pele e super sensivel e sempre ficava irritada com gilete ou cera. Com o LissPro, zero irritacao! A pele fica lisinha e sem aqueles pontinhos pretos.",
    likes: 145,
    photos: [],
  },
  {
    ...
    date: "ha 3 semanas",
    verified: true,
    text: "Comprei 2 porque ja sabia que ia amar! Um fica em casa e outro na bolsa de viagem. A depilacao e rapida e sem bagunca. Super pratico!",
    likes: 178,
    photos: [],
  },
  {
    ...
    date: "ha 1 mes",
    verified: true,
    text: "Depois de 8 semanas usando, minha virilha que vivia com foliculite esta completamente lisa e sem manchas. O resultado e impressionante! Valeu cada centavo.",
    likes: 132,
    photos: [],
  },
  {
    ...
    date: "ha 1 mes",
    verified: true,
    text: "Uso nas axilas e o resultado e otimo! Nao escurece a pele como a gilete fazia. A unica coisa e que demora um pouquinho pra se acostumar, mas depois flui.",
    likes: 89,
    photos: [],
  },
  {
    ...
    date: "ha 1 mes",
    verified: true,
    text: "Ja indiquei pra todas as minhas amigas! O LissPro mudou minha vida. Sem dor, sem pelos encravados, sem foliculite. Pele de bebe o ano inteiro!",
    likes: 201,
    photos: [],
  }
]
